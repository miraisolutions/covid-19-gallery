...
The goal of this gallery is to show an example of how a page can be created with [R Markdown website](https://bookdown.org/yihui/rmarkdown/rmarkdown-site.html) based on [JSON metadata](meta/resources.json) and then converted to static website using R package [**rmdgallery**](https://riccardoporreca.github.io/rmdgallery). See the [ReadMe](https://github.com/miraisolutions/covid-19-gallery) on our github page.
